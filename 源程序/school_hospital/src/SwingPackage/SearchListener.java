...
//	public SearchListener(MainWindow window)
//	{
//		//添加显示面板		
...
//	}
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		jifShow=new JInternalFrame("查询信息面板",true,true,true);
		//顶层面板
		displayUp=new JPanel();
		JLabel jTitle=new JLabel("查询信息");
...
//		myJTable.setSelectionMode(ListSelectionModel.MULTIPLE_INTERVAL_SELECTION);	//允许多选
		...
		jbSearch.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				...
				{
					JOptionPane.showMessageDialog(jifShow, "请选择查询信息类型","提示",1);
					return;
				}
				...
				{
					JOptionPane.showMessageDialog(jifShow, "请输入用户编号","提示",1);
					return;
				}
				try{
